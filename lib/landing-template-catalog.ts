...
export const TEMPLATE_CATEGORIES: TemplateCategory[] = [
  ...
  },
  {
    ...
    description: "Healthcare, legal, hospitality, and media.",
  },
];
...
export const TEMPLATE_CATALOG: TemplateCatalogEntry[] = [
  ...
  },
  {
    ...
    tagline: "Appointments & patient trust",
    bestFor: "Dentists, orthodontists, oral surgery",
    includes: ["Book CTA", "Services", "Stats", "Testimonial"],
  ...
  },
  {
    id: "legal",
    name: "Law firm",
    tagline: "Authoritative legal services",
    bestFor: "Attorneys, litigation, corporate counsel",
    includes: ["Practice hero", "Trust logos", "Consultation CTA"],
    category: "professional",
    preview: {
      brandColor: "#1E3A5F",
      mode: "light",
      brandName: "Whitmore Law",
      headline: "Clear counsel when stakes are high",
      radius: 4,
    },
  },
  {
    id: "spa",
    name: "Spa & wellness",
    tagline: "Treatments and relaxation",
    bestFor: "Day spas, massage, skincare studios",
    includes: ["Book treatment", "Packages", "Calm branding"],
    category: "professional",
    preview: {
      brandColor: "#9333EA",
      mode: "light",
      brandName: "Serene Spa",
      headline: "Restore balance, inside and out",
      radius: 12,
    },
  },
  {
    id: "podcast",
    name: "Podcast show",
    tagline: "Subscribe & listen landing",
    bestFor: "Podcasts, audio shows, interview series",
    includes: ["Listen CTA", "Episode highlights", "Stats"],
    category: "professional",
    preview: {
      brandColor: "#EA580C",
      mode: "dark",
      brandName: "Signal & Noise",
      headline: "Stories at the edge of tech and culture",
      radius: 14,
    },
  },
  {
    id: "hotel",
    name: "Boutique hotel",
    tagline: "Rooms & reservations",
    bestFor: "Hotels, B&Bs, vacation rentals",
    includes: ["Reserve CTA", "Room tiers", "Amenities"],
    category: "professional",
    preview: {
      brandColor: "#92400E",
      mode: "light",
      brandName: "The Linden",
      headline: "Quiet luxury in the heart of the city",
      radius: 8,
    },
  },
];
